...
function Databank() {
  ...
  <div className="container-fluid mt-5 px-3">
    ...
    <div className="d-flex justify-content-center">
      <div
        className="card w-100 d-flex flex-column flex-md-row rounded"
      ...
      >
        <img
          ...
          className="foto-databank rounded-top rounded-md-start"
        ...
        <div className="p-3 d-flex flex-column flex-grow-1">
          <h3 className="card-title text-white">{dataBank.properties.name}</h3>

          <p className="card-text text-white mt-3">{dataBank.description}</p>
          ...
          <button
            type="button"
            className="btn btn-outline-success rounded mt-auto"
            style={{ width: "13rem" }}
            onClick={handleClick}
          >
            Add to favorites
